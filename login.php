...
" for="exampleInputPassword">كلمة السر</label>
                                <div class="input-group">
                                    <div class="input-group-prepend bg-transparent">
                      <span class="input-group-text bg-transparent border-right-0">
                            ...
                            <div class="my-2 d-flex justify-content-between align-items-center">
                                <div class="form-check">
                                    <label class="form-check-label text-muted">
                                        <input type="checkbox" class="form-check-input"  style="    float: right;     font-family: cairo;

"/>
                                        حفظ تسجيل الدخول
                                    </label>
                                </div>
                                <a style="    float: right;     font-family: cairo;

"  href="register.php" class="auth-link text-black" style="color: #0d4dff">التسجيل للحصول على حساب
</a>
                            </div>
                            <div class="my-3">
                                <input style="    float: right;     font-family: cairo;

"  type="submit" name="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="تسجيل الدخول">
                            </div>
                        </form>
                    </div>
                </div>
