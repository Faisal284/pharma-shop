    ...
    <section>
        <div class="pageintro">
            ...
            <div class="pageintro-body">
                <h1 class="pageintro-title">البحث</h1>
            </div>
        </div>
    </section>
    <section>
        <div class="container p-t-100 p-b-70" dir="rtl">
            <div class="row">
                <div class="col-md-9">
                    <div class="shop-list">
                        <?php
                        ...
                        if (empty($search)) {
                            echo "يرجى إدخال بيانات المنتج التي تريد البحث عنها
                            ";
                        }
                        else
                        {
                        ...
                        {
                        echo "نتائج البحث <b>$total_record</b>  
                        <b>$search</b> <br><br>";
                        ?>
                        <div class="shop-list-body shop-list">
                                <?php
                                    ...
                                    <div class="shop-product">
                                        ...
                                        <div class="product-body" dir="rtl" style="    float: right;">
                                            ...
                                            <div class="product-button">
                                                <a href="cart.php?action=add&id=<?php echo $rows['product_id']?>" class="add-to-cart">اضافة المنتج للسلة </a>
                                            </div>
                                        </div>
                                    </div>
                                            <?php } ?>
                ...
                <?php
                    ...
                    echo "لم يتم العثور على منتجات مع الكلمة الأساسية
                    <b>$search</b>!";
                }
                }
                }
