...
<section>
    <div class="pageintro">
        ...
        <div class="pageintro-body" dir="rtl">
            <h1 class="pageintro-title">تفاصيل المنتج</h1>
...
<!-- Product Detail -->
<section>
    <div class="container p-b-90 p-t-100" dir="rtl">
        <div class="row">
            <div class="col-md-12">
                <div class="product-detail">
                    <div class="shop-product p-t-25">
                        ...
                        <div class="product-body">
                            ...
                            <?php } ?>
                            <span class="price"><?php echo number_format($product['selling_price'], 0, ',', '.') . " جنيه مصرى"; ?></span><br><br>
                            <div class="product-button">
                                ...
                                <a id="kypn" href='' onclick="getQty()" class="add-to-cart">أضف لسلة التسوق</a>
                            </div>
                            <div class="product-available">
                                <span>Status :</span>
                                <span style="color: orangered">المتوفر فى المخزن  </span>
                            </div>
                            <div class="product-categories">
                                <span class="text-black">القسم </span>
                                <?php
                    ...
                    <div class="au-tabs">
                        <ul class="nav nav-tabs">
                            <li class="active" >
                                <a data-toggle="tab" href="#description-tab" style="    text-align: center;
    direction: rtl; font-size:20px"class="active show">وصف مفصل
</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#review-tab">تعليق
</a>
                            </li>
                        </ul>
    ...
    direction: rtl; font-size:20px" ><?php echo $product['introduce']; ?></p>
                            </div>
                            <div id="review-tab" class="tab-pane">
                                <div class="fb-comments" data-href="http://localhost/PharmaTeamShop/product_detail.php?pid=<?php echo $product['product_id']; ?>" data-width="1170" data-numposts="5"></div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="grid-product">
                                        <div class="image bg-lightblue">
                                            ...
                                            <div class="addcart">
                                                <a href="cart.php?action=add&id=<?php echo $rows['product_id'] ?>">أضف لسلة التسوق</a>
                                            </div>
                                        </div>
                                        <a href="#" class="name"><?php echo $rows['product_name'] ?></a>
                                        <div class="price"><?php echo number_format($product['selling_price'], 0, ',', '.') . " جنيه مصرى"; ?></div>
                                    </div>
                                </div>
                            <?php
                            }
